...
let getXiaomangGoodsInfo = async (ctx, next) => {
    ...
    var body_request = {
        ...
        path: "/goods/info?goods_id=" + req_query.id + "&jd_province=&jd_city=&area_switch=0&preview=0",
        port: 443,
        method: "get",
        headers: {
...
let getJdCoupon = async (ctx, next) => {
    ...
    var body_request = {
        ...
        path: '/client.action?functionId=newBabelAwardCollection&client=wh5&body={"activityId":"2QwmJao59JSGzjWtEWsT5zgxk291","scene":1,"args":"key=' + req_query.key + ',roleId=' + req_query.roleId + ',strengthenKey=C225838DC1351F9ACA8548E3171FF8A4A79652C3B40AA10EA6208B56F12A9AF708B8A2FA5F5B50B95A49BC155D64D3A4_babel"}',
        port: 443,
        method: "get",
        headers: {
            //"Accept": "application/json",
...
let getJdTime = async (ctx, next) => {
    ...
    const res = await get('https://api.m.jd.com/client.action?functionId=queryMaterialProducts&client=wh5');
    /*****把接口返回的数据发送给前端*****/
    ctx.body = res
    console.log(res)
}
...
module.exports = { getXiaomangGoodsInfo, pullBark, getJdCoupon, getNewJdCoupon,getJdTime }
